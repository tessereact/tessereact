...
var Testshot = _react2.default.createClass({
    ...
    (0, _Fetch.postJSON)(url, {
      ...
      response.json().then(function (json) {
        var newData = _this.state.scenarios.map(function (s) {
          ...
          s.show = true;
          s.hasDiff = (0, _jsBeautify.html)(s.snapshot) !== s.previousSnapshot;
          return s;
        });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          (0, _map3.default)((0, _filter3.default)((0, _flatten3.default)((0, _partition3.default)(this.state.scenarios, function (s) {
            return s.hasDiff;
          })), function (s) {
            return s.show;
          }), function (value, i) {
              ...
              _react2.default.createElement(
                _ScenarioLink2.default,
                {
                  ...
                  onClick: function onClick() {
                    return _this2.handleSelect(value.name);
                  },
                  key: value.name,
  ...
  acceptSnapshot: function acceptSnapshot() {
    ...
    (0, _Fetch.postJSON)(url, {
      ...
      snapshot: (0, _jsBeautify.html)(this.state.selectedScenario.snapshot)
    }).then(function () {
  ...
  computeDiff: function computeDiff() {
    ...
    var left = previousSnapshot ? (0, _jsBeautify.html)(previousSnapshot, htmlFormatterOptions) : '';
    var right = snapshot ? (0, _jsBeautify.html)(snapshot, htmlFormatterOptions) : '';
    var diff = htmlDiffer.diffHtml(left, right);
