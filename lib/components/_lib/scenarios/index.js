...
function resolveScenario(scenarios, scenario, styles) {
  ...
  var snapshotCSS = options.css ? (0, _styles.buildSnapshotCSS)(styles, document.getElementById((0, _styles.generateScenarioId)(storedScenario)), document.documentElement, document.body) : null;
