...
var ScenarioView = function (_React$Component) {
  ...
  function ScenarioView(props, context) {
    _classCallCheck(this, ScenarioView);

    var _this = _possibleConstructorReturn(this, (ScenarioView.__proto__ || Object.getPrototypeOf(ScenarioView)).call(this, props, context));
