...
var ScenarioContent = function (_React$Component) {
  ...
  _createClass(ScenarioContent, [{
    ...
    value: function _renderContent(scenario, tab) {
      ...
      switch (tab) {
        case 'html':
          return _react2.default.createElement(_Diff2.default, { scenario: scenario, type: 'html', sideBySide: !this.state.splitView });
        case 'css':
          return _react2.default.createElement(_Diff2.default, { scenario: scenario, type: 'css', sideBySide: !this.state.splitView });
        case 'screenshot':
    ...
    value: function _renderScreenshot(screenshotSizes, savedScreenshots, index) {
      ...
      var width = screenshotSizes[index].width;


      return _react2.default.createElement(
        'div',
        { className: 'd2h-screenshot-diff' },
        _react2.default.createElement('img', { style: { width: width, minWidth: width }, src: savedScreenshots[index].url })
      );
    }
