...
var ScenarioContent = function (_React$Component) {
  ...
  _createClass(ScenarioContent, [{
    ...
    value: function render() {
      ...
      return scenario.hasDiff ? this._renderScenarioWithDiff(scenario) : this._renderScenarioWithoutDiff(scenario);
    }
  }, {
    key: '_renderScenarioWithDiff',
    value: function _renderScenarioWithDiff(scenario) {
      var _this2 = this;
    ...
    key: '_renderScenarioWithoutDiff',
    value: function _renderScenarioWithoutDiff(scenario) {
      var onAcceptSnapshot = this.props.onAcceptSnapshot;
