...
var Context = _react2.default.createClass({
  ...
  _shouldExpand: function _shouldExpand() {
    return this.props.selectedNode.name === this.props.node.name || this.props.selectedNode.context === this.props.node.name || this._hasFailingChildren() || this._applyFilter();
  },
