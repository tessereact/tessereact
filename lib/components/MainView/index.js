...
var MainView = function (_React$Component) {
  ...
  _createClass(MainView, [{
    ...
    value: function componentWillMount() {
      ...
      window.__tessereactConfig ? Promise.resolve(null) : (0, _requests.getJSON)('//' + this.props.host + ':' + this.props.port + '/config').then(function (config) {
      ...
      this.props.data.some(function (_ref) {
        ...
        return css;
      }) ? (0, _requests.getJSON)('//' + this.props.host + ':' + this.props.port + '/css').then(function (_ref2) {
    ...
    value: function _renderScenario(scenario) {
      ...
      var onAcceptSnapshot = scenario ? function () {
        return _this3._acceptSnapshot(scenario);
      } : function () {
        return null;
      };

      var onRequestScreenshot = scenario ? function (sizeIndex) {
