...
var MainView = function (_React$Component) {
  ...
  _createClass(MainView, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _onLoad2.default)().then(function () {
        ...
        if (!window.__tessereactConfig) {
          return (0, _requests.getJSON)('//' + _this2.props.host + ':' + _this2.props.port + '/config').then(function (response) {
        ...
        return Promise.all(chunks.map(function (scenariosChunk) {
          return (0, _requests.postJSON)(url, { scenarios: scenariosChunk }).then(function (response) {
            return response.json();
          }).then(function (_ref) {
            ...
            _this2.setState({ scenarios: newScenarios, cssLoaded: true });
          }).catch(function (e) {
    ...
    value: function _requestScreenshot(scenario, screenshotSizeIndex) {
      ...
      (0, _requests.postJSON)(url, { before: before, after: after, size: size }).then(function (response) {
