...
var MainView = function (_React$Component) {
  ...
  _createClass(MainView, [{
    ...
    value: function componentWillMount() {
      ...
      var url = '//' + this.props.host + ':' + this.props.port + '/read-snapshots';
      ...
      (0, _onLoad2.default)().then(function () {
        ...
        if (!window.__tessereactConfig) {
          return (0, _requests.getJSON)('//' + _this2.props.host + ':' + _this2.props.port + '/config').then(function (config) {
        ...
        return Promise.all(chunksToLoad.map(function (scenariosChunk) {
          return (0, _requests.postJSON)(url, { scenarios: scenariosChunk }).then(function (_ref) {
            var responseScenarios = _ref.scenarios;

            var newScenarios = responseScenarios.reduce(function (acc, s) {
              return (0, _scenarios.resolveScenario)(acc, s, styles);
        ...
        _this2.setState({ cssLoaded: true });
    ...
    value: function _acceptSnapshot(scenario) {
      ...
      var url = '//' + host + ':' + port + '/write-snapshot';
    ...
    value: function _requestScreenshot(scenario, screenshotSizeIndex) {
      ...
      this.setState({
        scenarios: (0, _scenarios.changeScenarioScreenshotData)(this.state.scenarios, scenario, function (_ref3) {
          var selectedScreenshotSizeIndex = _ref3.selectedScreenshotSizeIndex,
              savedScreenshots = _ref3.savedScreenshots;
          return {
      ...
      (0, _requests.postJSONAndGetURL)(url, { name: name, context: context, before: before, after: after, size: size, sizeIndex: screenshotSizeIndex }).then(function (url) {
        var scenarios = (0, _scenarios.changeScenarioScreenshotData)(_this5.state.scenarios, scenario, function (_ref4) {
