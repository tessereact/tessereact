    ...
    value: function _requestScreenshot(scenario, screenshotSizeIndex) {
      ...
      this.setState({
        scenarios: (0, _scenarios.changeScenarioScreenshotData)(this.state.scenarios, scenario, function (_ref4) {
          ...
          return selectedScreenshotSizeIndex === screenshotSizeIndex ? { selectedScreenshotSizeIndex: null } : { selectedScreenshotSizeIndex: screenshotSizeIndex };
        })
      });
      ...
      (0, _postJSON2.default)(url, { before: before, after: after, size: size }).then(function (response) {
        ...
        var scenarios = (0, _scenarios.changeScenarioScreenshotData)(_this6.state.scenarios, scenario, function (_ref5) {
