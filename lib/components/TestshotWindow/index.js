...
var TestshotWindow = function (_React$Component) {
  _inherits(TestshotWindow, _React$Component);

  function TestshotWindow(props, context) {
    _classCallCheck(this, TestshotWindow);

    var _this = _possibleConstructorReturn(this, (TestshotWindow.__proto__ || Object.getPrototypeOf(TestshotWindow)).call(this, props, context));
