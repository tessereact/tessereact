...
var TestshotWindow = _react2.default.createClass({
  ...
  componentWillMount: function componentWillMount() {
    ...
    var trigger = window.__diffCSS ? (0, _helpers.onLoad)() : Promise.resolve();

    trigger.then(function () {
      var styles = window.__diffCSS ? (0, _helpers.toArray)(document.styleSheets).reduce(function (array, _ref) {
        var rules = _ref.rules;
        return array.concat((0, _helpers.toArray)(rules).map(function (_ref2) {
      ...
      var scenarios = _this._scenariosToLoad().map(function (scenario) {
        console.log(scenario);
        var payload = {
          name: scenario.name,
          context: scenario.context,
          snapshot: (0, _formatter2.default)(scenario.getSnapshot())
        };
        return payload;
      });

      return (0, _fetch.postJSON)(url, {
        scenarios: scenarios,
        styles: styles
      });
      ...
      _this.setState({ scenarios: scenarios.reduce(_helpers.resolveScenario, _this.state.scenarios) });
