...
var TestshotWindow = _react2.default.createClass({
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          scenario.screenshotData && scenario.screenshotData.screenshotSizes.map(function (_ref4, index) {
            ...
            return _react2.default.createElement(
              ...
              { key: index, onClick: function onClick() {
                  return _this2._requestScreenshot(scenario, { width: width, height: height });
                } },
              alias || width + ' \u2A2F ' + height
            );
          }),
      ...
      scenario.screenshotData && scenario.screenshotData.url && this._renderScreenshot(scenario.screenshotData.url)
    );
  },
  ...
  _requestScreenshot: function _requestScreenshot(scenario, size) {
    var _this6 = this;
    ...
    (0, _postJSON2.default)(url, { before: before, after: after, size: size }).then(function (response) {
      ...
      var scenarios = (0, _scenarios.addScreenshotToScenario)(_this6.state.scenarios, scenario, url);
  ...
  _renderScreenshot: function _renderScreenshot(url) {
    return _react2.default.createElement(
      'div',
      { style: { paddingTop: 20 } },
