...
var TestshotWindow = _react2.default.createClass({
        ...
        _react2.default.createElement(
          ...
          scenario.screenshotData && _react2.default.createElement(
            ...
            { onClick: function onClick() {
                return _this2._requestScreenshot(scenario);
              } },
            'Get screenshot diff'
          ),
          _react2.default.createElement(
  ...
  _requestScreenshot: function _requestScreenshot(scenario) {
    var _this6 = this;
    ...
    (0, _postJSON2.default)(url, { before: before, after: after }).then(function (response) {
